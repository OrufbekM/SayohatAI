...
import { formatPrice } from '@/data/search-results'
    ...
    <article className="relative pt-2">
      ...
      >
        <div className="grid gap-5 lg:grid-cols-[1fr_1fr_auto] lg:items-center lg:gap-6">
          ...
          {/* O'ng: narx */}
          <div className="flex flex-col items-stretch gap-3 border-t border-gray-100 pt-4 lg:min-w-[220px] lg:border-t-0 lg:border-l lg:border-gray-100 lg:pt-0 lg:pl-6">
            ...
            <Button
              type="button"
              className="h-11 w-full rounded-lg bg-orange-500 text-base font-semibold text-white hover:bg-orange-600 lg:min-w-[160px]"
            >
              Bron qilish
            </Button>
          </div>
