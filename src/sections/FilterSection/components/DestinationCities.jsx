...
export function DestinationCities() {
  const { toCountryId, selectedCityIds, toggleCity, cities, citiesLoading } = useTours()
  ...
  const visibleCities = useMemo(
    () => filterByQuery(cities, search, ['name']),
    [cities, search],
  )
      ...
      <CardContent className="space-y-3 px-4 pb-4">
        ...
        <div className="max-h-40 overflow-y-auto pr-1">
          {!toCountryId ? (
            ...
            <p className="text-sm text-muted-foreground">Shaharlar yuklanmoqda...</p>
